...
def block_match_ncc(input_path):
    ...
    templates = [temp,temp1,temp2,temp3,temp4,temp5,temp6,temp7,temp8,temp9,temp10,temp11,temp12,temp13,temp14,temp15,temp16,temp17,temp18,temp19,temp20]
    ...
    open(input_path+"result_ncc.txt", 'w').close()
    with open(input_path+"result_ncc.txt", 'a') as out:
    ...
    for f in range(1,l):
        ...
        # cv2.imwrite("dem2/"+files[f], frame)
        cv2.waitKey(1)
